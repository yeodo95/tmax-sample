/* ASTx 1.3 | (C) Copyright AhnLab, Inc. | $Revision: 17791 $ */
...
function M(a){var c=b(a);null!=c&&window.setTimeout(function(){n(c)},1)}function v(a){var b=f(a);null!=b&&(a=$_astxu.getnc(a.value),b.text=a,h("e2e_settext",b,null,function(a){},function(){}))}function w(a){"function"===typeof a.stopPropagation&&a.stopPropagation();"function"===typeof a.preventDefault?a.preventDefault():a.returnValue=!1}function V(a,b,c){h("e2e_gettext",b,null,function(b){var c=$_astxu.getnc(b?b.result:"");$_astxu.isACK(c)&&(b=$_astxu.getnc(b.text),a.value=b)},function(){})}function W(a,
...
(f=!0);if(d=$_astxu.getCreatedFormValue(d,e,f))d.value=$_astxu.getnc(c.e2e_data)}},function(){})}function N(a){var c=b(a);if(null!=c){var e=f(c);if(null!=e){n(c);var g=$_astxu.getKeyCode(a);17==g&&(r=!0);if(1==r)return 86==g&&h("e2e_clear",e,null,function(a){c.value=""},function(){}),w(a),!1;if(1==(16==g||17==g||18==g?!0:!1))return!0;var p=!0;k&$ASTX2_CONST.OPTION_E2EFORM&&(e.e2e_type!=$ASTX2_CONST.E2ETYPE_CERT1&&e.e2e_type!=$ASTX2_CONST.E2ETYPE_CERT2||W(c,e));"function"===typeof $ASTX2_CUST.onHandlerKeyDown&&
0==$ASTX2_CUST.onHandlerKeyDown(c,a)&&(w(a),p=!1);1!=G||"text"!=c.type&&e.e2e_type!=$ASTX2_CONST.E2ETYPE_PLAIN1||0!=H||(1==p&&V(c,e,a),0==(8==g||9==g||13==g||20==g?!0:!1)&&(w(a),p=!1));return p}}}function O(a){var c=b(a);null!=c&&(17==$_astxu.getKeyCode(a)&&(r=!1),1==F&&v(c),window.setTimeout(function(){n(c)},1))}function P(a){var c=b(a);null!=c&&window.setTimeout(function(){n(c)},1)}function Q(a){if("IE"==$ASTX2_CONST.BROWSER_TYPE||"EG"==$ASTX2_CONST.BROWSER_TYPE){var c=b(a);null!=c&&""!=c.value&&
setTimeout(function(){if(""==c.value){var a=e(c);null!=a&&h("e2e_clear",a)}},1)}}function R(a){var c=b(a);null!=c&&("number"==typeof c.selectionStart?(c.selectionStart<c.value.length||c.selectionEnd<c.value.length)&&window.setTimeout(function(){n(c)},1):"undefined"!=typeof c.createTextRange&&document.selection&&(a=document.selection.createRange(),a.moveStart("character",-c.value.length),a.text.length<=c.value.length&&window.setTimeout(function(){n(c)},1)))}function X(a){}function S(a){h("e2e_unload")}
var k=0,A=[],Y=0,x=!1,E=0,l=-1,F=0,G=0,H=0,I=1,r=!1,q=[],z=!1,B="",C="";this.setOption=function(a){k|=a};this.setOptionStrings=function(a){A=a};this.attach=function(a,b){null!=a&&(E=a);k&$ASTX2_CONST.OPTION_AUTOSETTEXT&&(q=[]);k&$ASTX2_CONST.OPTION_E2EFORM&&y();for(var c=document.getElementsByTagName("input"),d=0;d<c.length;d++){var e=c[d];null!=e&&this.addObject(e)}s("e2e_init",null,null,function(a){J();$_astxu.addEvent(window,"blur",X);$_astxu.addEvent(window,"unload",S);$_astxu.addEvent(window,
"beforeunload",S);b&&b(!0)},function(){b&&b(!1)});x=!0};this.addObject=function(a){if(null!=a){var b=a.getAttribute("e2e_inputid");if(!(null!=b&&0<b)){var c=a.getAttribute("e2e_type");if(null==c||0>=c)if(c=a.getAttribute("e2e"),"true"==c||"on"==c)c=$ASTX2_CONST.E2ETYPE_CERT1,a.setAttribute("e2e_type",c);else{c=$ASTX2_CONST.E2ETYPE_NONE;try{if("function"===typeof $ASTX2_CUST.isE2EObject&&1==$ASTX2_CUST.isE2EObject(a)&&(c=$ASTX2_CONST.E2ETYPE_CERT1,a.setAttribute("e2e_type",c)),"function"===typeof $ASTX2_CUST.getE2Etype){var d=
$ASTX2_CUST.getE2Etype(a);d&&(c=d,a.setAttribute("e2e_type",c))}}catch(e){}if(c==$ASTX2_CONST.E2ETYPE_NONE)return}b=++Y;a.setAttribute("e2e_inputid",b);d=!0;k&$ASTX2_CONST.OPTION_AUTOSETTEXT&&0<a.value.length&&(d=!1,q.push(a));1==d&&(a.value="");a.setAttribute("autocomplete","off");g(a,!0);$_astxu.addEvent(a,"focus",K);$_astxu.addEvent(a,"blur",L);$_astxu.addEvent(a,"click",M);$_astxu.addEvent(a,"keyup",O);$_astxu.addEvent(a,"keydown",N);$_astxu.addEvent(a,"select",R);$_astxu.addEvent(a,"mouseup",
Q);$_astxu.addEvent(a,"mousedown",P);k&$ASTX2_CONST.OPTION_E2EFORM&&(c==$ASTX2_CONST.E2ETYPE_CERT1||c==$ASTX2_CONST.E2ETYPE_CERT2)&&(d=a.form,null!=d&&(a="password"==a.type?c==$ASTX2_CONST.E2ETYPE_CERT2?m($_astxu.getnc(a.name),$ASTX2_CONST.E2EFORM_TAG2_PWD):m($_astxu.getnc(a.name),$ASTX2_CONST.E2EFORM_TAG1_PWD):c==$ASTX2_CONST.E2ETYPE_CERT2?m($_astxu.getnc(a.name),$ASTX2_CONST.E2EFORM_TAG2):m($_astxu.getnc(a.name),$ASTX2_CONST.E2EFORM_TAG1),c=!1,k&$ASTX2_CONST.OPTION_E2EFORM_ALLTRIP&&(c=!0),$_astxu.getCreatedFormValue(d,
a,c)))}}};this.subObject=function(a){var b=e(a);if(null!=b){$_astxu.removeEvent(a,"focus",K);$_astxu.removeEvent(a,"blur",L);$_astxu.removeEvent(a,"click",M);$_astxu.removeEvent(a,"keyup",O);$_astxu.removeEvent(a,"keydown",N);$_astxu.removeEvent(a,"select",R);$_astxu.removeEvent(a,"mouseup",Q);$_astxu.removeEvent(a,"mousedown",P);try{a==document.activeElement&&h("e2e_blur",b)}catch(c){}a.value="";a.setAttribute("e2e_inputid",-1);a.setAttribute("e2e_type",-1);g(a,!1)}};this.getE2EHash=function(a,b){var c=
